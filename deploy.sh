...
echo ""
echo "2. Despliega en Render (Recomendado):"
...
echo ""
echo "3. O despliega en Vercel:"
echo "   - Ve a vercel.com"
echo "   - Importa tu repositorio"
echo "   - Configura las variables de entorno si es necesario"
echo ""
echo "4. O despliega manualmente con:"
